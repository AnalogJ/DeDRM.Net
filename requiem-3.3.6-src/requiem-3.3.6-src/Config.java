...
public class Config {
  ...
  public static String keyStore() {return keyStoreDirectory() + File.separator + "requiem-keystore"; }
  public static String sidb() { return keyStoreDirectory() + File.separator + "SC Info.sidb"; }
  public static String sidd() { return keyStoreDirectory() + File.separator + "SC Info.sidd"; }
